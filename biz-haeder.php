   ...
   <nav class="navbar navbar-default navbar-static-top" role="navigation">
    ...
    <div class="collapse navbar-collapse" id="bs-FA-navbar-collapse-1">
    	<ul class="nav navbar-nav">
    		...
    		<li><a href="index.html">PENDING SPECIALS</a></li>
    		<li><a href="index.html">MARKET INTEL</a></li>
        <li class="dropdown special"><a class="dropdown-toggle" data-toggle="dropdown" href="index.html">NEW SPECIAL <span class="caret"></span></a> <ul class="dropdown-menu" role="menu">
            <li><a href="#">Previous Specials</a></li>
            <li><a href="#">New Specials</a></li>
    </ul></li>
